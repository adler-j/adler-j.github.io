...
[width="50%",frame="topbot",cols="8,^2,^2",options="header"]
|======================
|Method | PSNR | SSIM
|FBP        | 33.65 |  0.830 
|TV        | 33.65 |   0.946 
