...
[width="50%", height="60%", frame="topbot",cols="8,^2,^2",options="header"]
|======================
|Method | PSNR | SSIM
|FBP        | 33.65 |  0.830 
|TV        | 33.65 |   0.946 
|Learned Denoiser        | 41.92 | 0.941 
|Learned Primal-Dual        | *44.11* | *0.969*
|======================

image:compare_results.png[compare_results, height=700, width=800]
