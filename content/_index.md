...
- **May 2024:** [AlphaFold 3]({{< ref "/publications/alphafold3" >}}) published in *Nature* — extending accurate structure prediction to biomolecular interactions.
- **Dec 2023:** First [Gemini]({{< ref "/publications/gemini" >}}) models released.
- **Jul 2021:** [AlphaFold]({{< ref "/publications/alphafold" >}}) published in *Nature*, alongside [structures for the human proteome]({{< ref "/publications/alphafold-human-proteome" >}}).
